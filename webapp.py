...
def index():
    ...
    if not topic:
        return render_template_string(PAGE, topic=None, result=None, error=None,
                                      source_count=0, pie_url=None, trend_url=None)

    outcome = run_analysis(topic, limit=50, save_history=True)
    if not outcome["ok"]:
        return render_template_string(PAGE, topic=topic, result=None,
                                      error=outcome["error"], source_count=0,
                                      pie_url=None, trend_url=None)
    ...
    return render_template_string(PAGE, topic=topic, result=result, error=None,
